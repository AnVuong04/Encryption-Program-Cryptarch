//Name: Will Maberry, Anthony Timberman, Fernando Cardenas, AnMinh Vuong 
//Date: 10/28/2023
      ...
      private class LeftPaint extends JPanel
      {
         ...
         public void paintComponent(Graphics g)
         {
            ...
            if(programCounter == 0)
            {
               ...
               drawString(g, "The purpose of this program is to show you how"
               + "\nvarious ciphers work."
               + "\nWe're going to start simple and get increasingly complex."
               + "\nThe hope is that you can't decode the string by"
            ...
            if(programCounter == 1)
            {
               ...
               + "\n\nThe entire alphabetical string is shifted over"
               + "\nfrom its original position."
               + "\n\nWhile there are only 92 different seeds to encode"
               + "\nwith this method,"
               + "\nthat doesn't mean it's super easy to break."
               + "\nWithout the original string, this message gets"
            ...
            if(programCounter == 4)
            {
               ...
               + "\nNot only did we add extra rows and colums,"
               + "\nbut we're also injecting"
            ...
            if(programCounter == 5)
            {
               ...
               + "\nWe'll use our monoalphabetic output as the input"
               + "\nfor our final cipher."
